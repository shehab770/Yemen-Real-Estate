      ...
      function locationData(
        ...
        return (
          ...
          '<div class="icon-box flex">'+
              '<div class="icons icon-1 flex"><span>Beds: </span><span class="fw-6">'+
                beds +
              '</span></div>'+
              '<div class="icons icon-2 flex"><span>Baths: </span><span class="fw-6">'+
                baths +
              '</span></div>'+
              '<div class="icons icon-3 flex"><span>Sqft: </span><span class="fw-6">'+
                sqft +
              '</span></div>'+
          "</div>"
          +
      ...
      var locations = [
        [
          locationData(
            ...
            "602 Main St, Suite A Edmonds, WA 98020",
            "60 Hullbrook Road, Billesley, B13 0LA",
            "$8,500",
            "5",
            "1",
            "1150",
        ...
        [
          locationData(
            "assets/images/img-box/map-location.jpg",
            "property-detail-v1.html",
            "604 Main St, Suite A Edmonds, WA 98020",
            "62 Hullbrook Road, Billesley, B13 0LA",
            "$9,500",
            "4",
            "3",
            "1150",
